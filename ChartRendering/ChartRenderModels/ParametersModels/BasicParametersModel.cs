...
public interface IBasicParametersModel : IParametersModel
{
}

public class BasicParametersModel : IBasicParametersModel
{
	...
	public static BasicParametersModel Default()
	{
