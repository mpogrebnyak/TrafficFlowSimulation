...
public class MovementThroughOneTrafficLightModeSettingsModel : BaseSettingsModels
{
	...
	public override object GetDefault()
	{
		return new MovementThroughOneTrafficLightModeSettingsModel
		{
			...
			{
				Text = ChartRenderModels.SettingsModels.Constants.FirstTrafficLightColor.Green.GetDescription(),
				Value = ChartRenderModels.SettingsModels.Constants.FirstTrafficLightColor.Green
			},
